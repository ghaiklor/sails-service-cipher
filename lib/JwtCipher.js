 ...
 */
JwtCipher.prototype.encode = function (data) {
  return Promise.resolve(this.encodeSync(data));
};
...
JwtCipher.prototype.encodeSync = function (data, _options) {
  ...
  options.algorithm = this.getAlgorithm();
  options.expiresInMinutes = this.getExpiresInMinutes();
